...
class Email_premios {
    ...
    public function enviarPremio() {
        ...
        $contenido .= "h3 {text-align: center; color: white; background: #fb185a; padding: 1rem; margin:0;}";
        ...
        $contenido .= "div {padding:1rem; background-color: #e6e6e6; border-radius: 2px;}";
        $contenido .= "</style>";
        $contenido .= "</head>";
        $contenido.="<h3>Hotel Rosa Bela & Convention center</h3>";
        $contenido .= "<div>";
        $contenido .= "<p><strong>¡Hola ".$this->nombre."! </strong> Premiamos tu fidelidad y por ello, te tenemos un premio por tener mas de ".$this->noches." noches con nosotros.</p>";
