...
function validarTipoContenido($tipo){
    $tipos=['centro', 'eventos', 'empleado', 'salon', 'habitaciones','re_habitaciones','chef', 'reserva', 'comentarios', 'chatbot','usuario_admin', 'usuario', 'premio','chat', 'comentarios','beneficio','chatbot'];
...
function mostrarNotificacion($codigo){
    ...
    switch($codigo){
        ...
        case 4:
            ...
            break;
        case 5:
            $mensaje="El status fue actualizado correctamente";
            break;
        default:
            $mensaje=false;
            break;
