...
<a href="/chef/mostrar" class="boton boton-rosado">Volver</a> 
    ...
    <form class="formulario" method="POST" action="/chef/crear" enctype="multipart/form-data">
        <?php include 'formulario.php' ;?>
        <input type="submit" id="btnEnviar" value="Registrar chef" class="boton boton-rosado">
    </form>
