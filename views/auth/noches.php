...
<main class="contenedor">
    ...
    <p>Se puede buscar por: nombre, apellido, correo electronico y numero de identificacion del usuario. Al igual que por el codigo del plan de fidelizacion.</p>
    <div class="flex_busqueda">
        ...
        <div class="form_eliminar_registro">
            <form class="form_eliminar_noches">
              
                <button class="boton-rojo-block_noches" value="Eliminar">Limpiar registros</button>
            </form>
        </div>
            ...
            <?php foreach ($usuarios as $indice => $usuario) : ?>
                <?php if ($indice % 2 === 0) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="body_infor_div">
                            <p class="descripcion p_break"><?php echo $usuario->nombre; ?> </p>
                        </div>
                        ...
                        <div class="body_infor_div">
                            <p class="bold"><?php echo $usuario->noches; ?></p>
                        </div>
                        <div class="body_infor_div">
                            <p class="bold"><?php echo $usuario->noches * 100; ?></p>
                        </div>
                        <div class="body_infor_div">
                            <?php
                            $con = 0;
