...
<a href="/centrosconsumo/mostrar" class="boton boton-rosado">Volver</a> 

    <h1>Registrar Centro de Consumo</h1>
    ...
    <form class="formulario" method="POST" action="/centrosconsumo/crear" enctype="multipart/form-data">
        <?php include 'formulario.php' ;?>
        <input type="submit" id="btnEnviar" value="Registrar centro" class="boton boton-rosado">
    </form>
