...
<a href="/beneficios/mostrar" class="boton boton-rosado">Volver</a> 
<div class="espacio3"></div>
    ...
    <form class="formulario" method="POST" action="/beneficios/crear" >
        <?php include 'formulario.php' ;?>
        <input type="submit" id="btnEnviar" value="Registrar beneficio" class="boton boton-rosado">
    </form>
